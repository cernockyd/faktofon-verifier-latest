...
import {
  ...
  type ChatClientEventEmitter,
} from "./events";
import type {
  StreamChunk, // AnyClientTool,
  // ContentPart,
  ModelMessage,
  ContentPart,
} from "@tanstack/ai";
...
import type { Action } from "../hook/types";
...
export class ChatClient {
  ...
  private normalizeMessageInput(input: string | MultimodalContent): {
    content: string | Array<ContentPart | ActionPart>;
    id?: string;
  } {
